...
export default function JunoNotFound() {
  return (
    <main className="flex min-h-[60dvh] flex-1 flex-col items-center justify-center gap-4 px-6 text-center">
      <p className="text-[13px] font-semibold tracking-[0.2em] text-j-faint">404</p>
      <h1 className="text-[22px] font-bold tracking-tight">Nothing here on this cluster</h1>
      <p className="max-w-[360px] text-[15px] text-j-muted">
        No coin, creator or post at this address. A mint from another cluster
        looks exactly like this one and will not resolve here.
      </p>
      <Link
        href="/explore"
        className="mt-1 inline-flex h-11 items-center rounded-full bg-j-pos px-6 text-[15px] font-semibold text-j-bg"
      >
        Browse the market
      </Link>
    </main>
