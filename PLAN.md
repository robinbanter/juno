...
| 0.9 | Unit tests + production build green | DONE — 123 tests, 11 files: 66 after the Norr purge (which deleted the tests covering deleted code — was 140), +29 for the Pyth reader/band/source suite, +9 for the issuer tooling, +10 for the mainnet-fork config, +9 for wallet sessions |
...
| **Engineering total** | **72** | **74** | **97.3%** |

**Engineering: 72 / 74 = 97.3%.** The open items are 2.6 and I.5 (browser-wallet
...
- **123 unit tests across 11 files passing**, including Meteora's own
